...
public class MyPasswordField extends JPasswordField {
    ...
    public MyPasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/icon/eye_hide.png")).getImage();
    ...
    private void initBorder() {
        ...
        setBorder(javax.swing.BorderFactory.createEmptyBorder(10, left, 10, right+15));
    }
}
